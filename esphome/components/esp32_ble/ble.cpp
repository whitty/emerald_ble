...
bool ESP32BLE::ble_setup_() {
  ...
  if (this->auth_req_mode_set_) {
    err = esp_ble_gap_set_security_param(ESP_BLE_SM_AUTHEN_REQ_MODE, &this->auth_req_mode_, sizeof(esp_ble_auth_req_t));
    if (err != ESP_OK) {
