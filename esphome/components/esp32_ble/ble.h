...
class ESP32BLE : public Component {
 public:
  ...
  void set_auth_req(AuthReqMode req) { this->auth_req_mode_set_ = true; this->auth_req_mode_ = (esp_ble_auth_req_t) req; }
 ...
 protected:
  ...
  esp_ble_auth_req_t auth_req_mode_{ESP_LE_AUTH_NO_BOND};
  bool auth_req_mode_set_{false};
